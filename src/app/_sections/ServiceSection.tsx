		...
		<section className="my-[64px] bg-[#1D1D1F] py-[100px]">
			<article className="px-10">
				<Heading large color="light" className="leading-snug">
					<span className="block">이 모든 것을</span>
					<span className="block">대행하는 마케팅</span>
					<span className="block">파트너 솔루션</span>
				</Heading>
			</article>
...
const AdditionalServices = () => {
	return (
		<div className="px-4">
			<Heading>
				<span className="block">그리고,</span>
				<span>파격적인 무료 서비스.</span>
			</Heading>
